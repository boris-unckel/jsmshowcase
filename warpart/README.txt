...
a persistence unit "warpartPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "warpart\pom.xml":
...
artifact ("warpart.war") is already built. You can build
